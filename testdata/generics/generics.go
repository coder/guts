...
type UnusedField[C comparable, A any, T Custom, S Single] struct {
}

type BasicGeneric[A any] struct {
	Val A
}

type UnusedGeneric[B any] struct {
	// Unsure on the best behavior here
}
